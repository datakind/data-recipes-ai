...
def send_message(driver, message, num_tries=0, tot_tries=3):
    """
    ...
    try:
        ...
        if num_tries <= tot_tries:
            ...
            return send_message(driver, message, num_tries + 1, tot_tries)
        else:
    ...
    status = poll_page(driver, MARKDOWN_BODY_CLASS)
    if status is False:
